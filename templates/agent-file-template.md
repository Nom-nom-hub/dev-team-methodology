...
1. **Review**: Review from all team perspectives using `/team.review`
1. **Planning**: Create implementation plan with team input using `/team.plan`
1. **Tasks**: Generate actionable tasks with team ownership using `/team.tasks`
1. **Implementation**: Execute implementation with team collaboration using `/team.implement`
