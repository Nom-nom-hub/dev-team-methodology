...
## Critical Task Definition Rules
...
- ✗ "Implement parser functionality" → ✓ "Create src/parsers/javascript_parser.py with JSParser class"
- ✗ "Research performance" → ✓ "Benchmark tree-sitter parsing on 10,000 file test set, document results in research.md"
- ✗ "Write tests" → ✓ "Create tests/test_cli.py with unit tests for analyze command with 5+ test cases"
- ✗ "Deploy to production" → ✓ "Package tool as pip package, test installation, upload to PyPI"
