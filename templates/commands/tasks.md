...
The text the user typed after `/team.tasks` in the triggering message **is** the task generation focus or additional requirements. Assume you always have it available in this conversation even if `{ARGS}` appears literally below. Do not ask the user to repeat it unless they provided an empty command.
...
2. **Extract key information from the specification and plan**:
...
3. **Generate tasks organized by implementation phase**:
   - Phase 1: Research & Design Tasks
   - Phase 2: Implementation Tasks
   - Phase 3: Testing Tasks
   - Phase 4: Deployment Tasks

4. **Assign team role ownership for each task**:
...
5. **Define cross-team dependencies**:
...
6. **Estimate task duration and priority**:
...
7. **Create team resource allocation plan**:
...
9. **Establish team communication plan**:
   - Define daily standup schedule
   - Define weekly sync schedule
   - Plan for task update frequency
   - Establish escalation procedures

10. **Create team risk mitigation plan**:
    - Identify risks specific to task execution
    - Define mitigation strategies
    - Assign risk owners

11. **Define team success criteria for task execution**:
    - Task completion criteria
    - Team performance metrics
    - Delivery success metrics

12. **Write the tasks to** `specs/[BRANCH]/tasks.md` using the team template structure, with proper assignment and tracking information.
...
2. Assign each task to specific team role with accountable owner
3. Identify all cross-team dependencies
4. Estimate duration and priority for all tasks
5. Define team resource allocation
6. Create milestone definitions with team validation points
7. Establish team communication schedule
8. Define team risk mitigation strategies
9. Update agent context with new task information
